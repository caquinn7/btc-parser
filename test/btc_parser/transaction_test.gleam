...
pub fn is_null_outpoint_requires_null_hash_and_max_vout_test() {
  ...
  assert !transaction.is_null_outpoint(zero_hash_regular_vout)
  assert !transaction.is_null_outpoint(nonzero_hash_max_vout)
}
