import btc_parser/transaction.{
  ...
  NullData, OtherWitnessProgram, P2A, P2PK, P2PKH, P2SH, P2TR, P2WPKH, P2WSH,
  Unrecognized,
}
...
pub fn classify_output_script_bare_multisig_count_21_is_unrecognized_test() {
  let key = key_push(1, 33, 0xAA)
...
pub fn classify_output_script_bare_multisig_rejects_nonminimal_count_pushes_test() {
  let key = key_push(1, 33, 0xAA)
...
pub fn classify_output_script_bare_multisig_rejects_nonminimal_script_number_test() {
  let key = key_push(1, 33, 0xAA)
...
pub fn classify_output_script_bare_multisig_incorrect_key_payload_size_is_unrecognized_test() {
  let script_bytes = <<
    0x51,
    0x20,
...
pub fn classify_output_script_bare_multisig_key_count_mismatch_is_unrecognized_test() {
  let key = key_push(1, 33, 0xAA)
...
pub fn classify_output_script_bare_multisig_trailing_opcode_is_unrecognized_test() {
  let key = key_push(1, 33, 0xAA)
  let script_bytes =
